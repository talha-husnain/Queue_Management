...
public class ModemBankSimulation {
  ...
  public void runSimulation(int lengthOfSimulation, double averageDialInTime, int averageConnectionTime,
    ...
    while (currentTime < lengthOfSimulation) {
      // Randomly determining how many users are trying to dial in at the current
      // time.
    ...
    double modemUsagePercentage = (numModems > 0) ? (double) totalModemBusyTime / (numModems * lengthOfSimulation) * 100
        : 0;
